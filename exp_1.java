...
//        try {
//            /**Добавление элементов в десятичный массив**/
//            String new_summ = String.valueOf(summ);
//            int index_10system = 2;
//            int index = 0;
//
//            while (index_10system != 8) {
//
//                nums_10system[index] += new_summ.charAt(index_10system);
//
//                index++;
//                index_10system++;
//            }
//
//            /**Вывод списка в 10-тичной форме**/
//            for (int i = 0; i < nums_10system.length; i++) {
//                System.out.println(nums_10system[i]);
//            }
//        } catch (Exception e){
